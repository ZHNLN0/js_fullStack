// miniprogram/pages/diray/diary.js
import {dateFormat} from '../../lib/utils'
const app = getApp()
const globalData = app.globalData
import {getEmotionByOpenidAndData, jscode2session, addEmotion} from '../../lib/api'
Page({
  ...
  getUserInfo() {
    ...
    function callback(){
      ...
      if(globalData.curentMonthData && globalData.curentMonthData.length){
        const now = new Date()
      }else {
